...
lmeAR2=lme(fixed=CESD_rac_carr~ time_5*(factor(CENTRE)+factor(antidep0)+I(AGE0-65)+som)+factor(ETUDE_clas0)+factor(SEXE)+factor(SEXE):som
           , random=~ time_5 | ID,
           data = base2, method="ML",na.action=na.omit, correlation = corCAR1(form = ~time_5 | ID))
...
jm1=jointModel(lmeObject = lmeAR,
           survObject = coxFit,
           timeVar = "time_5",
           parameterization = "value", # association = pente courante non bruit?e
